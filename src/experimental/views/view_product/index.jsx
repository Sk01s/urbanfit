...
import ColorChooserV2 from "@/experimental/components/common/ColorChooserV2";
...
const ViewProductV2 = () => {
  ...
  useEffect(() => {
    if (allProductsV2.length > 0 && product?.relative) {
      setRelatedProduct(
        allProductsV2.filter((item) => product.relative.includes(item.id))
      );
    }
    return () => {
      setRelatedProduct([]);
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:image" content={variant?.image || product?.image} />
              ...
              <div className="product-modal-details">
                        ...
                        {variant.price ? (
                          ` ${displayMoney(
                            Number(variant.price) *
                              (1 - Number(variant.percentage) / 100)
                          )}  `
                        ) : (
                          <Skeleton width={40} />
                        )}
                ...
                {colors.length >= 1 && (
                  <div>
                    ...
                    <ColorChooserV2
                      colors={colors.map((c) => ({ color: c.color, name: c.name }))}
                  ...
                  <div>
                    ...
                    <div className="product-sizes-container">
                      ...
                      <button
                        ...
                        disabled={variant.smQuantity > 0 ? false : true}
                      ...
                      <button
                        ...
                        className={`product-size ${
                          variant.mdQuantity || "not-available"
                        }`}
                        disabled={variant.mdQuantity > 0 ? false : true}
                      ...
                      <button
                        ...
                        className={`product-size ${
                          variant.lgQuantity || "not-available"
                        }`}
                        disabled={variant.lgQuantity > 0 ? false : true}
                      ...
                      <button
                        ...
                        className={`product-size  ${
                          variant.xlQuantity || "not-available"
                        }`}
                        disabled={variant.xlQuantity > 0 ? false : true}
                    ...
                    {({ onClickToggle }) => (
                      <button
                        className={`button basket-toggle ${
                          isItemOnBasket(product.id, selectedColor, selectedSize)
                            ? "button-border button-border-gray"
                            : ""
                        }`}
                        style={{
                          background: isItemOnBasket(product.id, selectedColor, selectedSize) && "#6f6f6f",
                          color: "#fff",
                          lineHeight: "1em",
                          height: "auto",
                          margin: "0",
